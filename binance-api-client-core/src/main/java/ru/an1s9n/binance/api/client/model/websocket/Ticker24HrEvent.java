...
import static ru.an1s9n.binance.api.client.config.BinanceApiConfig.Endpoints.ALL_MARKET_TICKER_24_HR_STREAM_NAME;
import static ru.an1s9n.binance.api.client.config.BinanceApiConfig.Endpoints.INDIVIDUAL_SYMBOL_TICKER_24_HR_STREAM_NAME;

...
import static ru.an1s9n.binanceapiclient.config.BinanceApiConfig.Endpoints.ALL_MARKET_BOOK_TICKER_STREAM_NAME;
import static ru.an1s9n.binanceapiclient.config.BinanceApiConfig.Endpoints.INDIVIDUAL_SYMBOL_BOOK_TICKER_STREAM_NAME;
